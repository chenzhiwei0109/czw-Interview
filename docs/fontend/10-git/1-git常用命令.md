...
![lifecycle](../../.vuepress/public/assets/img/lifecycle-1604287948780.png)
...
- 工作区(开发过程工作的目录)
- 暂存区域(用来存储阶段性变更)
- Git 仓库(存储的是不同阶段性的版本号的版本)  `git commit -m 初始化项目` 

![areas](../../.vuepress/public/assets/img/areas-1604287948781.png)
...
```bash
# czw 合并到 master，需要切换到 master 分支
git merge 被合并分支
