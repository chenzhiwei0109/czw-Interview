			...
			<template #form>
				...
				label-width="80px">
					...
					<el-form-item label="会员等级" class="mb-0">
						<el-select v-model="search.group_id" size="mini"
						placeholder="请选择会员等级">
							<el-option label="区域一" 
...
![image-20200908080143277](../../.vuepress/public/assets/img/image-20200908080143277.png)
    ...
    <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="升级条件">
            ...
            <div>
                ...
                <small class="text-secondary d-block">设置会员等级所需要的购买量必须大于等于0,单位：笔</small>
            </div>
        </el-form-item>
