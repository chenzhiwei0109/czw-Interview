...
- 必须在text组件内写文字!!
- 无法获取main.js里添加的全局属性，需要import

## 逻辑处理

## 布局

![image-20201006200036360](../../../.vuepress/public/assets/img/image-20201006200036360.png)
...
- nvue页面
  ...
  - view默认flex布局，子项flex-1就会默认占满剩余空间
...
<view class="page">
    ...
    <!-- 底部 -->
    <view style="position: fixed;left: 0;bottom: 0;right: 0;height: 120rpx;" ></view>
...
<view style="position: fixed;left: 0;right: 0;" :style="'top:'+statusBarHeight+'px'">
    ...
    <view style="height: 80rpx;" class="px-2 flex justify-between align-center">
        ...
        <view style="width: 325rpx;background-color: rgba(0,0,0,0.4);" class="flex rounded-circle">
            <view class="p">
                <image src="../../static/info/title.jpg" style="width: 70rpx;height: 70rpx;" class="rounded-circle"></image>
            </view>
